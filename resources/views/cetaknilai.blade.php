...
<html>
<head>
	<title>Laporan Nilai {{Session::get('a_sekolah')}}</title>
...
@endforeach
	<div class="container">
		<table align="center" style="width:90%">
			<tr>
				<td colspan="3">
					<a href="/sikupas/public/daftarpertemuan/tampil/{{$p->id_pertemuan}}/nilai/{{$t_p->id_tugaspertemuan}}/cetaknilai/pdf" class="btn btn-primary" target="_blank">DOWNLOAD PDF</a>
				</td>
			</tr>
		</table>
		<table align="center" style="width:90%">
		...
		<table style="width:90%" class='table table-bordered' align="center">
			<thead>
				<tr>
					...
					<th style="width:13%; text-align:center; vertical-align: center;">Tanggal Kumpul</th>
					<th style="width:12%; text-align:center; vertical-align: center;">Jam Kumpul</th>
