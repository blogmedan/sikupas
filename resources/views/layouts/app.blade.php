...
echo '<script type="text/javascript">
           window.location = "/cabdissunggal/public/siswa"
      </script>';
}else{
?>
<!DOCTYPE html>
...
<script>
function reloadDIV () {document.getElementById("chatku").innerHTML.reload}

function reloadDIV () {$('#chatku').load(self)} 
</script>
<!--script>
		$(document).ready(function(){
			setInterval(function(){$("#chatku").load('chat.php')}, 2000);
		});
</script-->
